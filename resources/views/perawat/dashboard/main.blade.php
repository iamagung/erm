...
<div class="col-md-12 col-md-12">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="col-lg-12 col-md-12">
                <form method="post" action="{!! route('dashboardPerawatchart') !!}">
                    {{ csrf_field() }}
                    <div class="col-lg-4 col-md-4" style="padding: 0px">
...
<script type="text/javascript">
    ...
    function checkTime(i)
    {
        ...
        Highcharts.chart('container', {
            ...
            series: [
            {
                name: '{!! $dokter->namaPoli !!}',
                data: [
                    <?php
                    for ($i=0; $i < 7; $i++) { 
                        $tglt = date('Y-m-d',strtotime("+ $i days",strtotime($tgle)));
                        $jum = count(DB::connection('rsu')->table('tr_tracer')->where('Tgl_Register','like',$tglt.'%')->where('Kode_Poli',$dokter->kodePoli)->get());
                        echo "$jum,";
                    }
                    ?>
                ]
