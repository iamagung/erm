	...
	<form id="tahap3">
		...
		<div class="box box-success">
			...
			<div class="box-body">
						...
						<div class="col-lg-6 col-md-6">
							...
							<div class="col-lg-12 col-md-12" style="padding: 0px">
								...
								<?php if($rekap->foto_anamnesis!=''){ ?>
									...
									<div class="clearfix"></div>
								<?php } ?>
								<textarea class="form-control" placeholder="Anamnesis (S)" name="anamnesis">{{($rekap->anamnesis != '')?$rekap->anamnesis:(($rekap2)?$rekap2->anamnesis_perawat:'')}}</textarea>
							</div>
							<div class="clearfix" style="margin-bottom: 10px"></div>
							<div class="col-lg-12 col-md-12" style="padding: 0px">
								...
								?>
								<textarea class="form-control" placeholder="Pemeriksaan Fisik (O)" name="pemeriksaanFisik">{{(!empty($rekap->pemeriksaanFisik))?$rekap->pemeriksaanFisik:(($rekap2)?$rekap2->pemeriksaanFisik_perawat:'')}}</textarea>
							</div>
							<!-- <div class="clearfix" style="margin-bottom: 10px"></div>
							<div class="col-lg-12 col-md-12" style="padding: 0px">
							...
							<div class="col-lg-12 col-md-12" style="padding: 0px">
								<div class="col-lg-8 col-md-8" style="padding: 0px">
									<label class="col-lg-12 col-md-12" style="padding: 0px">Tindakan (ICD 9)</label>
									<div class="clearfix"></div>
							...
							<div class="col-lg-12 col-md-12" style="padding: 0px">
								<div class="col-lg-8 col-md-8" style="padding: 0px">
									<label class="col-lg-12 col-md-12" style="padding: 0px">Tindakan (ICD 9 CM)</label>
									<div class="clearfix"></div>
									<textarea style="display: none" class="form-control" placeholder="Text Here" name="tindakan9cm"></textarea>
								</div>
								<div class="col-lg-4 col-md-4" style="padding: 0px">
									<div class="clearfix"></div>
									<textarea style="display: none" class="form-control" placeholder="Text Here" name="icd9cm">{{$rekap->icd9}}</textarea>
								</div>
							</div>
							<div class="clearfix" style="margin-bottom: 10px"></div>
							<div class="col-lg-12 col-md-12" style="padding: 0px">
							...
							<div class="col-lg-12 col-md-12" style="padding: 0px">
								...
								?>
								<textarea class="form-control" placeholder="Text Here" name="rencana3">{{(isset($rekap2->rencana_terapi_perawat)?$rekap2->rencana_terapi_perawat:'')}}</textarea>
							</div>
							<div class="clearfix" style="margin-bottom: 10px"></div>
							<label class="col-lg-12 col-md-12" style="padding: 0px">Instruksi PPA Termasuk Pasca Bedah</label>
							<div class="clearfix"></div>
							<textarea class="form-control" placeholder="Instruksi Ditulis dengan Rinci Dan Jelas (Kosongi jika tidak ada instruksi)" name="instruksi_ppa">{{(isset($rekap2->instruksi_ppa_perawat))?$rekap2->instruksi_ppa_perawat:''}}</textarea>
							<div class="clearfix" style="margin-bottom: 10px"></div>
								...
								<tbody id="data_tarif_tindakan">
									...
									@if(count($data_tnt) > 0)
										@foreach ($data_tnt as $key => $dt)
											...
											@php 
												array_push($arr, $dt->NamaTindakan);
												$tot += $dt->TarifTindakan;
											@endphp
										@endforeach
										@if(!in_array("Konsultasi ke Dokter Spesialis", $arr))
											@if(!isset($rekap->jenis_kasus) && $rekap->aksi_dokter != 1)
									...
									<tr id="total_tarif_head">
										...
										<td id="total_tnt" colspan="2" style="text-align: center;">Rp. {{(int) $tot}}</td>
										<input type="hidden" name="total_tarif_tindakan" id="total_tarif_tindakan" value="{{(int) $tot}}">
										<!-- @if(count($data_tnt) > 0)
											@foreach ($tnt as $key => $dt)
												@if($dt->NamaTindakan == "Konsultasi ke Dokter Spesialis")
							...
							<select name="tarif_tindakan_lab" id="tarif_tindakan_lab" class="form-control">
								<option value="">.:: Pilih Tindakan Laboratorium ::.</option>
							</select>
							<div class="clearfix" style="margin-bottom: 10px"></div>
							<label>Daftar Pilihan Tindakan Laboratorium</label>
							<table id="table_tarif_tindakan_lab" class="table table-bordered">
								<thead>
									<tr>
										<th>Tindakan</th>
										<th>Tarif Layanan</th>
								...
								<tbody id="data_tarif_tindakan_lab">
									<tr id="default_title_tindakan_lab">
										<td colspan="4" style="text-align: center;">Tidak Ada Tindakan Laboratorium</td>
									</tr>
									<tr id="total_tarif_tindakan_lab_head">
										<td colspan="2" style="text-align: center;"><strong>Total Tarif</strong></td>
										<td id="total_ttl" colspan="2" style="text-align: center;">Rp. 0</td>
										<input type="hidden" name="total_tarif_tindakan_lab" id="total_tarif_tindakan_lab" value="">
									</tr>
								</tbody>
							</table>
							<div class="clearfix" style="margin-bottom: 10px"></div>
							<label>Tindakan Radiologi</label>
							<select name="tarif_tindakan_radiologi" id="tarif_tindakan_radiologi" class="form-control">
								<option value="">.:: Pilih Tindakan Radiologi ::.</option>
							</select>
							<div class="clearfix" style="margin-bottom: 10px"></div>
							<label>Daftar Pilihan Tindakan Radiologi</label>
							<table id="table_tarif_tindakan_radiologi" class="table table-bordered">
								<thead>
									<tr>
										<th>Tindakan</th>
										<th>Tarif Layanan</th>
								...
								<tbody id="data_tarif_tindakan_radiologi">
									<tr id="default_title_tindakan_radiologi">
										<td colspan="4" style="text-align: center;">Tidak Ada Tindakan Radiologi</td>
									</tr>
									<tr id="total_tarif_tindakan_radiologi_head">
										<td colspan="2" style="text-align: center;"><strong>Total Tarif</strong></td>
										<td id="total_ttl" colspan="2" style="text-align: center;">Rp. 0</td>
										<input type="hidden" name="total_tarif_tindakan_radiologi" id="total_tarif_tindakan_radiologi" value="">
									</tr>
								</tbody>
							</table>
						</div>
					...
					<div class="clearfix" style="margin-bottom: 10px"></div>
					@if(auth::user()->kodePoli == 117 && !empty($rekap2->anamnesis_terapis))
						{{-- Fisioterapi --}}
...
<script type="text/javascript" language="JavaScript">
    ...
    function(){
		...
		function simpantahap3(redir){
			...
			if(i==0){
				$("input[name=jenis_kasusnya]").val("dokter");
