...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Unit - {!! $identitas->nama_web !!}</title>
    ...
    <body class="skin-black">
        <header class="header">
            <a href="{!! route('home') !!}" class="logo" style="background: #d400d7">Unit web</a>
            ...
            <aside class="left-side sidebar-offcanvas">
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="@if($active == 3) active @endif"><a href="{!! route('dataRegistUnit') !!}"><i class="fa fa-users"></i> <span>Input Rekam Medis</span></a></li>
