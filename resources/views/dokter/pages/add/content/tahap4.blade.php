...
<div class="col-lg-12 col-md-12 tahap4" style="padding: 0px">
			...
			<div class="col-lg-12 col-md-12" style="padding: 0px">
				<div class="form-group">
					...
					<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
						...
						<br>
						<label> <input type="checkbox" name="bahasa_dipakai[]" value="Jawa" {!! $check[3] !!}> Jawa</label>
						<label style="margin-left: 20px"> <input type="checkbox" name="bahasa_dipakai[]" value="Madura" {!! $check[4] !!}> Madura</label>
						<br/>
						<div class="col-lg-12 col-md-12" style="padding: 0px">
							<div class="col-lg-4 col-md-4" style="padding: 0px">
								<label> <input type="checkbox" id="bahasa_dipakai" name="bahasa_dipakai[]" value="Bahasa_lainnya" {!! $check[5] !!}> Lainnya</label>
							</div>
		...
		<div class="col-lg-6 col-md-6">
			<div class="col-lg-12 col-md-12" style="padding: 0px">
				<div class="form-group">
					...
					<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
						<input type="text" name="hambatan_emosional" class="form-control" value="{{(isset($rekap2))?$rekap2->hambatan_emosional_edu:''}}" placeholder="Jika Ya, Sebutkan. (Kosongi jika tidak)">
					</div>
				</div>
				<div class="clearfix" style="margin-bottom: 10px"></div>
				<div class="form-group">
	...
	<div class="col-lg-12 col-md-12" style="box-shadow: 0px 10px 10px #ddd;background: #fafafa">
		...
		<table class="table table-bordered">
			<tr>
				...
				<td><input type="text" name="nama_edukator" class="form-control" placeholder="Ex: Dr. xxxxxxxxx SPPK" value="{{$dokter->Nama_Dokter}}"></td>
			</tr>
			<tr>
	...
	<div class="clearfix" style="margin-bottom: 10px"></div>
	<div class="col-lg-12 cl-md-12" style="text-align: center;">
		<a href="javascript:void(0);" onclick="simpantahap4()" class="btn btn-success">Simpan</a>
	</div>
	</form>
</div>
<div class="clearfix"></div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var val = $('#bidang_edukator').val('DOKTER');
		html += `
		...
		if(i==0){
			$.post("{!! route('simpanTahap4') !!}",data,function(data){
				if(data.status=='success'){
					...
					swal("Notice!",'Tidak ada perubahan data','info');
				}
			});
		}
	}
