						...
						<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12' style='padding:0px'>
							...
							// if($kategori!=2){
								...
								<div class="form-group">
									...
									<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
										<input type="file" name="gambar[]" class="form-control upload" onchange="loadFilePhoto(event)" required multiple>
										<img id="preview-photo" src="{!! url('asminasset/assets/img/default-50x50.png') !!}" class="img-polaroid" width="200" style="display: none">
									</div>
								</div>
								<?php
							// }
