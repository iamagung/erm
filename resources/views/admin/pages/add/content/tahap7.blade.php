    ...
    <div class="col-lg-12 col-md-12 tahap7" style="padding: 0px">
        ...
        <table class="table table-bordered">
            ...
            <tbody id="hasilradiologi">
                ...
                // $dbcon = pg_connect("host='localhost' user='postgres' password='root' dbname='dicom'");
                ...
                if($total!=0){
                    while($arr = pg_fetch_array ($result)){
                        $ur = "http://192.168.1.8/rs_wahidin/public/dwv/viewers/static/index.php?id=file:///Z:/installer/dicomserver1417d/data/".str_replace('\\', '/', $arr['objectfile']);
                     echo '<tr>';
    ...
    function tampilkanRadio(data){
        ...
        if(d==0){
            ...
            for(var i=0;i<d;i++){
                ...
                '<td><a href="http://192.168.1.8/rs_wahidin/public/dwv/viewers/static/index.php?id=file:///Z:/'+url_gam+'" target="_blank">'+data.data[i]['objectfile']+'</a></td>'+
                '<td>'+tgl+'</td>'+
                '</tr>';
            }
        }
