					...
					<div class="col-lg-12 col-md-12">
						...
						<div class="form-group">
							...
							<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
								...
								?>
								<label> <input type="checkbox" {!! $check[0] !!} value="Tenang" name="status_psikologi[]"> Tenang</label>
								<label style="margin-left: 20px"> <input type="checkbox" {!! $check[1] !!} value="Cemas" name="status_psikologi[]"> Cemas</label>
								<label style="margin-left: 20px"> <input type="checkbox" {!! $check[2] !!} value="Sedih" name="status_psikologi[]"> Sedih</label>
								<label style="margin-left: 20px"> <input type="checkbox" {!! $check[3] !!} value="Depresi" name="status_psikologi[]"> Depresi</label>
								<label style="margin-left: 20px"> <input type="checkbox" {!! $check[4] !!} value="Marah" name="status_psikologi[]"> Marah</label>
								<label style="margin-left: 20px"> <input type="checkbox" {!! $check[5] !!} value="Hiperaktif" name="status_psikologi[]"> Hiperaktif</label>
								<label style="margin-left: 20px"> <input type="checkbox" {!! $check[6] !!} value="Mengganggu Sekitar" name="status_psikologi[]"> Mengganggu Sekitar</label>
								<label> <input type="checkbox" {!! $check[7] !!} value="Lain-lain" name="status_psikologi[]"> Lain-lain <input type="text" name="status_psikologi_lain" value="{{$lain}}" readonly></label>
							</div>
						</div>
						<div class="clearfix" style="margin-bottom: 10px"></div>
						<div class="form-group">
							...
							<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
								...
								<div class="col-lg-12 col-md-12" style="padding: 0px">
									<div class="col-lg-4 col-md-4" style="padding: 0px">
										<label> <input type="checkbox" {!! $check[0] !!} id="hambatanBahasa" value="Bahasa"> Bahasa</label>
								...
								<label> <input type="checkbox" {!! $check[1] !!} value="Cacat/ Fisik/ Kognitif (Gangguan Penglihatan/ Pendengaran/ Lain)"> Cacat/ Fisik/ Kognitif (Gangguan Penglihatan/ Pendengaran/ Lain)</label>
						...
						<div class="form-group">
							...
							<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
								...
								?>
								<label> <input type="radio" {!! $check[0] !!} name="status_pernikahan" value="Menikah" checked> Sudah Menikah</label>
		...
		<div class="box box-success">
			...
			<div class="box-body">
					<div class="col-lg-12 col-md-12" style="padding: 0px">
						<div class="col-lg-6 col-md-6">
							...
							<div class="col-lg-12 col-md-12" style="padding: 0px">
								...
								?>
								<br/><label><input type="radio" {{$check[0]}} name="gizi" value="1">Gizi Kurang/ Buruk</label>
								<br/><label><input type="radio" {{$check[1]}} name="gizi" value="2">Gizi Cukup</label>
								<br/><label><input type="radio" {{$check[2]}} name="gizi" value="3">Gizi lebih</label>
							</div>
							<div class="clearfix" style="margin-bottom: 10px"></div>
							<div class="col-lg-12 col-md-12" style="padding: 0px">
						...
						<div class="col-lg-6 col-md-6">
							...
							<div class="col-lg-12 col-md-12 tahap5" style="padding: 0px">
								...
								?>
								Obat E-Resep
								<!-- <a href="{{route('eresep')}}" target="_blank" class="btn btn-sm btn-primary">E Resep</a> -->
								<a href="javascript:void(0)" onclick="simpantahap3(1)" class="btn btn-sm btn-primary">E Resep</a>
					...
					<div class="col-lg-12 col-md-12" style="text-align: center;">
						<a href="javascript:void(0);" class="btn btn-success" onclick="simpantahap3(0)">Simpan</a>
					</div>
					<div class="clearfix" style="margin-bottom: 10px"></div>
			</div>
		</div>
