...
<div class="col-lg-12 col-md-12" style="padding: 0px">
    ...
    <div class="col-lg-12 col-md-12 tahap5" style="padding: 0px">   
        ...
        <?php
        $rekap = DB::table('trrawatjalanobat')->select('No_Register')->where('No_RM',Session::get('no_RM'))->limit(10)->distinct()->orderBy('No_Register','DESC')->get();
        $total = DB::table('trrawatjalanobat')->select('No_Register')->where('No_RM',Session::get('no_RM'))->distinct()->get();
        // $rekap = DB::table('trrawatjalanobat')->select('No_Register')->limit(10)->distinct()->get();
        // $total = DB::table('trrawatjalanobat')->select('No_Register')->distinct()->get();
        ?>
                    ...
                    foreach ($rekap as $key) {
                        ...
                        <tr>
                            ...
                            <td>
                                <ol>
                                <?php
                                $obat = DB::table('trrawatjalanobat')->select('NamaBrg','Jml','Satuan','TS')->where('No_register',$key->No_Register)->get();
                            ...
                            <td>
                                <?php
                                $tracer = DB::table('tr_tracer')->where('No_Register',$key->No_Register)->first();
                                $tg = '-';
                                if(count($tracer)!=0){
