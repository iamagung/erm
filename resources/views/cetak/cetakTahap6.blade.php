...
<body>
	...
	<table width="100%">
		<tr>
			<td style="font-size: 20px;font-weight: bold;text-align: center;border: 1px solid #000">PENEMPELAN LABORATORIUM</td>
		</tr>
		<tr>
			<td style="border: 1px solid #000">
				<table width="100%" border="1">
					...
					if($syarat->foto_lab==''){
						...
						$st = explode("+", $syarat->foto_lab);
						$st1 = explode("+", $syarat->ket_lab);
