...
<style type="text/css">
    ...
    @keyframes blinkingBackground{
		50%		{ background-color: #ebef0a;}
		100%	{ background-color: #42f11f;}
        0%      { background-color: #42f11f;}
	}
</style>
    ...
    <div class="board-inner">
        ...
        <ul class="nav nav-tabs" id="myTab">
            <?php
                ...
                $customer = DB::connection('rsu')->table('tm_customer')->where('KodeCust',Session::get('no_RM'))->first()->TglLahir;
                // $umurcust = date_diff(date_create(substr($customer->TglLahir,0,10)), date_create(date('Y-m-d')))->format('%y');
                $umurcust = date_diff(date_create(substr($customer,0,10)), date_create(date('Y-m-d')))->format('%y');
                $display2='';
                $display3='';
            ...
            <li class='{{$active[7]}}' style="text-align:center;">
                <a href="{{route('pembuatanObat')}}" title="E-Resep">
                    <span class="round-tabs three">
                        <!-- <b style="font-size: 35px;">2</b> -->
                        <img src="{!! asset('adminAsset/img/icon/1-1.png') !!}">
                    </span>
                </a>
                <span class="text-success" style="position: relative; bottom: 15px;">E-Resep</span>
            </li>
        ...
        <div class="box-header">
            ...
            <div class="box-tools">
                <div class="col-lg-6 col-md-6">
                    ...
                    @if($umurcust >= 65)
                        <h4><span class="notif-geri" >Pasien Ini Termasuk Pasien Geriatri</span></h4>
                    @endif
                </div>
                <div class="col-lg-6 col-md-6">
